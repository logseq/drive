...
type model = { count : int; typed : string; dialog_open : bool }
type action = Increment | Typed of string | Open_dialog | Close_dialog

let initial = { count = 0; typed = ""; dialog_open = false }
